...
import me.imflowow.tritium.core.modules.components.informations.ClockEntity;
...
public class ClockDisplay extends Module {
	...
	public PositionValue position = new PositionValue("ClockDisplay", new Position(10, 10, Direction.Left, Direction.Top));

	public ClockDisplay() {
		super("ClockDisplay", "Display your clock on your screen.");
		super.addValues(textColor, backgroundColor);
		super.addGuiEntities(new ClockEntity(this.position));
	}
