...
import me.imflowow.tritium.core.modules.components.informations.CoordEntity;
...
public class CoordDisplay extends Module {
	...
	public PositionValue position = new PositionValue("CoordDisplay", new Position(10, 10, Direction.Left, Direction.Top));

	public CoordDisplay() {
		super("CoordDisplay", "Display your Coord on your screen.");
		super.addValues(textColor, backgroundColor);
		super.addGuiEntities(new CoordEntity(this.position));
	}
