...
import me.imflowow.tritium.core.modules.CoordDisplay;
...
public class CoordEntity extends GuiEntity {
    private String text;

    public CoordEntity(PositionValue position) {
        super(position);
    }
    ...
    public void draw(double x, double y) {
        this.text = (int) mc.thePlayer.posX + ", " + (int) mc.thePlayer.posY + ", " + (int) mc.thePlayer.posZ;
    ...
    public CoordDisplay getModule() {
        return (CoordDisplay) Tritium.instance.getModuleManager().getModule(CoordDisplay.class);
    }
}
