...
import tritium.api.utils.event.events.BlockBeRenderedEvent;
import tritium.api.utils.event.events.BoundingBoxEvent;
...
public class Block
{
	...
	public boolean shouldSideBeRendered(IBlockAccess worldIn, BlockPos pos, EnumFacing side) {
		...
		BlockBeRenderedEvent event = new BlockBeRenderedEvent(worldIn, pos, this, side, maxX, minX, maxY, minY, maxZ, minZ);
