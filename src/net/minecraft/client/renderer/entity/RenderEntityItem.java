...
import me.imflowow.tritium.core.modules.ItemPhysic;
import me.imflowow.tritium.core.modules.utils.ItemPhysicRender;
...
public class RenderEntityItem extends Render<EntityItem>
{
    ...
    {
    	if(Tritium.instance.getModuleManager().getModule(ItemPhysic.class).isEnabled())
    	{
