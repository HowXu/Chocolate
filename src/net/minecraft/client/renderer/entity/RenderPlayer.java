...
import me.imflowow.tritium.client.cape.CapeLayer;
import me.imflowow.tritium.client.cape.WingLayer;
...
import tritium.api.utils.event.events.RenderPlayerEvent;
...
public class RenderPlayer extends RendererLivingEntity<AbstractClientPlayer>
{
    ...
    public void doRender(AbstractClientPlayer entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        ...
        EventManager.call(new RenderPlayerEvent(entity, this, partialTicks, x, y, z));
    }
    ...
    public void renderRightArm(AbstractClientPlayer clientPlayer)
    {
        ...
        modelplayer.isRiding = modelplayer.isSneak = false;//TODO fixed a bug..
