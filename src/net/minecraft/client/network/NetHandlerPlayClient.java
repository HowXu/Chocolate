...
//        this.gameController.displayGuiScreen(new GuiDownloadTerrain(this));
		...
		this.netManager.sendPacket(new C17PacketCustomPayload("MC|Brand",
				(new PacketBuffer(Unpooled.buffer())).writeString("fml,forge,Tritium")));
		this.netManager.sendPacket(new C17PacketCustomPayload("REGISTER",
				(new PacketBuffer(Unpooled.buffer())).writeString("Tritium-X")));
	}
