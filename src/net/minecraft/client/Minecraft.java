...
import tritium.api.utils.event.events.LoadWorldEvent;
import tritium.api.utils.event.events.MouseEvent;
import tritium.api.utils.event.events.TickEvent;
import tritium.api.utils.event.events.TickEvent.Phase;
import tritium.api.utils.render.special.SplashRender;
...
//		this.drawSplashScreen(this.renderEngine);
		//这里是加载动画进度条的来源
		//我做了点小小的修改让它多了一个字符串
		SplashRender.drawSplashScreen(0,"1/18 - ResourceManager");
		this.skinManager = new SkinManager(this.renderEngine, new File(this.fileAssets, "skins"), this.sessionService);
		SplashRender.drawSplashScreen(5,"2/18 - SkinManager");
		this.saveLoader = new AnvilSaveConverter(new File(this.mcDataDir, "saves"));
		SplashRender.drawSplashScreen(10,"3/18 - AnvilSaveConverter");
		this.mcSoundHandler = new SoundHandler(this.mcResourceManager, this.gameSettings);
		SplashRender.drawSplashScreen(15,"4/18 - SoundHandler");
		this.mcResourceManager.registerReloadListener(this.mcSoundHandler);
		SplashRender.drawSplashScreen(20,"5/18 - RegisterReloadListener");
		this.mcMusicTicker = new MusicTicker(this);
		SplashRender.drawSplashScreen(25,"6/18 - MusicTicker");
		...
		SplashRender.drawSplashScreen(30,"7/18 - FontRenderer PreInitialization");
		...
		SplashRender.drawSplashScreen(35 , "8/18 - FontRenderer Initialization");
		...
		SplashRender.drawSplashScreen(40,"9/18 - FontRenderer PostInitialization");
		...
		SplashRender.drawSplashScreen(45,"10/18 - Register Finish");
		...
		SplashRender.drawSplashScreen(50,"11/18 - Game Setting");
		...
		SplashRender.drawSplashScreen(55,"12/18 - Game Startup");

		this.textureMapBlocks = new TextureMap("textures");
		this.textureMapBlocks.setMipmapLevels(this.gameSettings.mipmapLevels);
		SplashRender.drawSplashScreen(60,"13/18 - MipmapLevels");
		this.renderEngine.loadTickableTexture(TextureMap.locationBlocksTexture, this.textureMapBlocks);
		this.renderEngine.bindTexture(TextureMap.locationBlocksTexture);
		SplashRender.drawSplashScreen(65,"14/18 - RenderEngine Blind");
		this.textureMapBlocks.setBlurMipmapDirect(false, this.gameSettings.mipmapLevels > 0);
		SplashRender.drawSplashScreen(70,"15/18 - BlurMipmapDirect");
		this.modelManager = new ModelManager(this.textureMapBlocks);
		this.mcResourceManager.registerReloadListener(this.modelManager);
		SplashRender.drawSplashScreen(75,"16/18 - ModelManager");
		this.renderItem = new RenderItem(this.renderEngine, this.modelManager);
		this.renderManager = new RenderManager(this.renderEngine, this.renderItem);
		this.itemRenderer = new ItemRenderer(this);
		this.mcResourceManager.registerReloadListener(this.renderItem);
		this.entityRenderer = new EntityRenderer(this, this.mcResourceManager);
		SplashRender.drawSplashScreen(80,"17/18 - ItemRender");
		this.mcResourceManager.registerReloadListener(this.entityRenderer);
		this.blockRenderDispatcher = new BlockRendererDispatcher(this.modelManager.getBlockModelShapes(),
				this.gameSettings);
		this.mcResourceManager.registerReloadListener(this.blockRenderDispatcher);
		SplashRender.drawSplashScreen(85,"18/18 - BlockRendererDispatcher");
		this.renderGlobal = new RenderGlobal(this);
		this.mcResourceManager.registerReloadListener(this.renderGlobal);
		this.guiAchievement = new GuiAchievement(this);
		SplashRender.drawSplashScreen(100,"Finish and OptiFine Working ...");
...
//		Display.setResizable(true);
	...
	private void setWindowIcon() {
		...
		if (util$enumos != Util.EnumOS.OSX) {
			...
			try {
				inputstream = Minecraft.class
						.getResourceAsStream("/assets/minecraft/tritium/icons/icons/icon_16x16.png");
				inputstream1 = Minecraft.class
						.getResourceAsStream("/assets/minecraft/tritium/icons/icons/icon_32x32.png");
	...
	public boolean shouldRun(BlockPos blockpos) {
		if (this.thePlayer.isUsingItem()) {
			return true;
		} else {
			return this.playerController.onPlayerDamageBlock(blockpos, this.objectMouseOver.sideHit);
		}
	}
	...
	public void runTick() throws IOException {
		...
		if (this.currentScreen == null || this.currentScreen.allowUserInput) {
			...
			while (Mouse.next()) {
				...
				MouseEvent eventMouse = new MouseEvent(i, Mouse.getEventButtonState());
...
//		System.gc();
	...
	public void setSessionService(MinecraftSessionService auth) {
		this.sessionService = auth;
	}
