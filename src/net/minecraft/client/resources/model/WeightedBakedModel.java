...
public class WeightedBakedModel implements IBakedModel
{
    ...
    static class MyWeighedRandomItem extends WeightedRandom.Item implements Comparable<WeightedBakedModel.MyWeighedRandomItem>
    {
        ...
        {
            return ComparisonChain.start().compare(p_compareTo_1_.getItemWeight(), this.getItemWeight()).compare(this.getCountQuads(), p_compareTo_1_.getCountQuads()).result();
        }
        ...
        {
            return "MyWeighedRandomItem{weight=" + this.getItemWeight() + ", model=" + this.model + '}';
        }
    }
}
