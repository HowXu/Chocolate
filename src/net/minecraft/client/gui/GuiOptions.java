...
public class GuiOptions extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void initGui()
    {
        ...
        //交换了自定义皮肤和Optinfine抽风的Super设置，删除了匿名信息反馈选项

        this.buttonList.add(new GuiButton(110, this.width / 2 + 5, this.height / 6 + 72 - 6, 150, 20, I18n.format("options.skinCustomisation", new Object[0])));
        /*
        this.buttonList.add(new GuiButton(8675309, this.width / 2 + 5, this.height / 6 + 72 - 6, 150, 20, "Super Secret Settings...")
        {
