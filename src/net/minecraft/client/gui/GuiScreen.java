...
import me.imflowow.tritium.core.globals.ScreenBackground;
...
public abstract class GuiScreen extends Gui implements GuiYesNoCallback {
	...
	public void handleInput() throws IOException {
		if (Mouse.isCreated()) {
			while (Mouse.next()) {
				GuiScreenMouseInputEvent event = new GuiScreenMouseInputEvent(this);
	...
	public void drawWorldBackground(int tint) {
		if (this.mc.theWorld != null) {
			if (Tritium.instance.getModuleManager().getModule(ScreenBackground.class).isEnabled())
