...
import cn.howxu.gui.GuiMultiplayersInGame;
...
public class GuiIngameMenu extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        //此处绘制游戏内暂停GUI 鉴于懒得研究Tritium的翻译机制所以直接上中文了
        this.buttonList.add(new GuiButton(1023330, this.width / 2 - 100, this.height / 4 + 72 + i, "服务器列表"));
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        switch (button.id)
        {
            ...
            case 7:
                ...
                */
            case 1023330:
                this.mc.displayGuiScreen(new GuiMultiplayersInGame());
                break;
        }
    }
