...
import me.imflowow.tritium.core.modules.CustomParticles;
...
public class EntityFX extends Entity {
	...
	public float getRedColorF() {
		CustomParticles module = (CustomParticles) Tritium.instance.getModuleManager().getModule(CustomParticles.class);
		if (module.isEnabled())
			return module.color.getValue().getColor().getRed() / 255.0f;
	...
	public float getGreenColorF() {
		CustomParticles module = (CustomParticles) Tritium.instance.getModuleManager().getModule(CustomParticles.class);
		if (module.isEnabled())
			return module.color.getValue().getColor().getGreen() / 255.0f;
	...
	public float getBlueColorF() {
		CustomParticles module = (CustomParticles) Tritium.instance.getModuleManager().getModule(CustomParticles.class);
		if (module.isEnabled())
			return module.color.getValue().getColor().getBlue() / 255.0f;
	...
	public float getAlpha() {
		CustomParticles module = (CustomParticles) Tritium.instance.getModuleManager().getModule(CustomParticles.class);
		if (module.isEnabled())
			return module.color.getValue().getColor().getAlpha() / 255.0f;
	...
	public void renderParticle(WorldRenderer worldRendererIn, Entity entityIn, float partialTicks, float rotationX,
		...
		worldRendererIn
				...
				.color(this.getRedColorF(), this.getGreenColorF(), this.getBlueColorF(), this.getAlpha()).lightmap(j, k)
				.endVertex();
		worldRendererIn
				.pos((double) (f5 - rotationX * f4 + rotationXY * f4), (double) (f6 + rotationZ * f4),
						(double) (f7 - rotationYZ * f4 + rotationXZ * f4))
