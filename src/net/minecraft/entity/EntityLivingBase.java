...
public abstract class EntityLivingBase extends Entity {
	...
	private int getArmSwingAnimationEnd() {
		BlockAnimations module = (BlockAnimations) Tritium.instance.getModuleManager().getModule(BlockAnimations.class);
		return module.SwingSpeed.getValue();
	}
