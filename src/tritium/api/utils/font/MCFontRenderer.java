package tritium.api.utils.font;
...
import tritium.api.utils.font.CFont.CharData;
...
public class MCFontRenderer extends CFont {
	...
	public MCFontRenderer(Font font, boolean antiAlias, boolean fractionalMetrics, double offsetX, double offsetY) {
	...
	public MCFontRenderer(Font font, boolean antiAlias, boolean fractionalMetrics, boolean chinese, double offsetX,
			double offsetY) {
	...
	public float drawOutlineString(String text, double x, double y, int color, int onlineColor) {
		String outlinetext = StringUtils.removeFormattingCodes(text);
		drawString(outlinetext, x + 0.5, y, onlineColor, false);
		drawString(outlinetext, x - 0.5, y, onlineColor, false);
		drawString(outlinetext, x, y + 0.5, onlineColor, false);
		drawString(outlinetext, x, y - 0.5, onlineColor, false);
		return drawString(text, x, y, color, false);
	}
